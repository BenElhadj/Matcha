      ...
      <q-form class="forgot mt-5 my-4">
        ...
        <q-form class="my-4">
          ...
          <q-input
            ...
            @keyup.enter="recover"
          ></q-input>
          <q-btn block large color="primary" @click.prevent="recover" class="my-5" type="submit"
            >Send</q-btn
          >
...
const emailRule = (v) => {
  ...
  return (alert.value = {
    state: true,
    color: 'red',
    text: 'Please provide a valid email and ensure it has a length between 10 and 55 characters.'
  })
}

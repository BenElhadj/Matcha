<template>
  <q-layout>
    <q-container v-if="loaded" class="pt-5 px-0 discover">
      <q-layout wrap justify-center>
        <q-col :cols="search ? 4 : 8" :md="search ? 3 : 8" :sm="10">
          <q-container>
            <q-layout column>
              <h4 class="title mb-4">Afficher</h4>
              <q-btn-toggle v-model="gender" class="mb-5">
              ...
              <!-- D'autres composants Quasar ici -->
            </q-layout>
          </q-container>
        </q-col>
        <!-- Autres parties du layout -->
      </q-layout>
    </q-container>
    <Loader v-else />
  </q-layout>

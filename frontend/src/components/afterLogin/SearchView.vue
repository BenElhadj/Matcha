        ...
        <q-container px-md-5>
          <q-layout column>
            ...
            <q-btn-toggle class="mb-5" v-model="gender">
              <q-btn class="toggle_btn" text outlined color="primary" value="male"
                ><q-icon>mdi-gender-male</q-icon>
                <span class="px-1">Hommes</span>
              </q-btn>
              <q-btn class="toggle_btn" text outlined color="primary" value="female"
                ><q-icon>mdi-gender-female</q-icon>
      ...
      if (!res.data.msg) {
        ...
        if (props.data.gender || props.data.location) {
          ...
          if (
            props.data.min &&
            props.data.max &&
            !isNaN(props.data.max) &&
            !isNaN(props.data.min) &&
            Number(props.data.max) >= Number(props.data.min)
          ) {
...
.tags_menu.q-select--is-menu-active > .v-input__control > .v-input__slot,
.loaction_input.v-input--is-focused > .v-input__control > .v-input__slot {
  opacity: 1;
}

.loaction_input > .v-input__control > .v-input__slot > .q-input__slot > input {
  margin: 0;
}
...
.v-menu__content.menuable__content__active.q-select__content > .q-select-list > .v-list {
...
.sort_select.q-select--is-menu-active > .v-input__control > .v-input__slot {
  opacity: 1;
}
</style>

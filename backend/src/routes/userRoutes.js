...
// Qui m'a bloqué (paginated, même handler que /browse/blockedby)
routes.get('/blockedby', authCheck, browsing.getBlockedBy)
// Qui j'ai signalé (paginated, même handler que /browse/reported)
routes.get('/reported', authCheck, browsing.getReported)
// Qui m'a signalé (paginated, même handler que /browse/reportedby)
